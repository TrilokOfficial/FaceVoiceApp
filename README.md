        ...
        while True:
            ...
            if data.get("type") == "video_frame":
                ...
                try:
                    ...
                    # Detect faces with more restrictive parameters to reduce false positives
                    faces = face_cascade.detectMultiScale(
                        gray, 
                        scaleFactor=1.05,  # Smaller scale factor for better accuracy
                        minNeighbors=6,    # Higher neighbor requirement
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        if 0.7 <= aspect_ratio <= 1.3:  # Valid face aspect ratio
                            # Check if the detected region has enough variation (not a plain surface)
                            face_region = gray[y:y+h, x:x+w]
                            if face_region.size > 0:
                                std_dev = np.std(face_region)
                                if std_dev > 15:  # Enough texture variation
                    ...
                    for i, (x, y, w, h) in enumerate(faces):
                        ...
                        # Add face label with confidence indicator
